...
namespace C_Sharp_Cording_Test_Practice
{
    ...
    class 기사단원의_무기
    {
        static void Main(string[] args)
        {
            ...
            int _num01 = 5, _num02 = 10;
            int _limit = 3;
            int _power = 2;

            Console.WriteLine(_solution.solution(_num01, _limit, _power));          //  10
            Console.WriteLine(_solution.solution(_num02, _limit, _power));          //  21
        }
    }
    */
}

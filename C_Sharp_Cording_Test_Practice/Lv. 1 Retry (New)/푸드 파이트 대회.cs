 ...
 * 물을 편의상 0번 음식이라고 칭한다면, 두 선수는 1번 음식 1개, 2번 음식 2개, 3번 음식 3개씩을 
 * 먹게 되므로 음식의 배치는 "1223330333221"이 됩니다. 따라서 1번 음식 1개는 대회에 사용하지 못합니다.
 * 
...
namespace C_Sharp_Cording_Test_Practice
{
    ...
    public class Solution
    {
        public string solution(int[] food)
        {
            ...
            //  문자열을 뒤집고, 하나의 문자열로 결합
            _str = String.Concat(answer.Reverse());
            // 왼쪽 선수의 음식 + 물(0) + 오른쪽 선수의 음식(뒤집은 문자열) 반환
            return answer + "0" + _str;
        }
    }
    class 푸드_파이트_대회
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(_solution.solution(_food01));     //  1223330333221
            Console.WriteLine(_solution.solution(_food02));     //  111303111
        }
    }
    */
}
 ...
 * 첫 번째 카드 뭉치에서 "i"를 사용한 후 두 번째 카드 뭉치에서 "want"와 "to"를 
 * 사용하고 첫 번째 카드뭉치에 "drink"와 "water"를 차례대로 
 * 사용하면 원하는 순서의 단어 배열을 만들 수 있습니다.
 * 
...
namespace C_Sharp_Cording_Test_Practice
{
    ...
    class 카드_뭉치
    {
        static void Main(string[] args)
        {
            ...
            string[] _cards01 = { "i", "drink", "water" };
            string[] _cards11 = { "i", "water", "drink" };
            string[] _cards02 = { "want", "to" };

            string[] _goal = { "i", "want", "to", "drink", "water" };

            Console.WriteLine(_solution.solution(_cards01, _cards02, _goal));       //  Yes
